...
namespace Root.Code.Apis.E01D.Runtimic.Execution.Binding.Metadata.Members
{
        ...
        where TContainer : RuntimicContainer_I<TContainer>
    {
		...
		public new Root.Code.Apis.E01D.Runtimic.Execution.Binding.Metadata.Members.TypeParameters.TypeParameterApi_I<TContainer> TypeParameters { get; set; }
	    ...
	    Root.Code.Apis.E01D.Runtimic.Execution.Binding.Metadata.Members.TypeParameters.TypeParameterApiMask_I MemberApiMask_I.TypeParameters => TypeParameters;


        TypeApiMask_I MemberApiMask_I.Types => Types;

        public BoundTypeDefinitionMask_I GetDeclaringType(InfrastructureModelMask_I model, MemberReference memberReference)
        {
