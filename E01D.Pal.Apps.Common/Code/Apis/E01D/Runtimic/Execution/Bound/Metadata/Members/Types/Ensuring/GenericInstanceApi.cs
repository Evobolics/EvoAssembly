...
namespace Root.Code.Apis.E01D.Runtimic.Execution.Binding.Metadata.Members.Types.Ensuring
{
    ...
    {
        public SemanticTypeDefinitionMask_I Ensure(InfrastructureModelMask_I semanticModel, BoundModule_I convertedModule, TypeReference input, BoundTypeDefinitionMask_I declaringType, System.Type type)
        {
	    ...
	    public BoundTypeDefinitionMask_I EnsureGenericBlueprint(InfrastructureModelMask_I semanticModel, BoundTypeDefinition bound)
	    {
