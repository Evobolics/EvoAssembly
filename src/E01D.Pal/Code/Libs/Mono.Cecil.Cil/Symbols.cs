...
{ 
	...
	public class DefaultSymbolReaderProvider : ISymbolReaderProvider {
		...
		public ISymbolReader GetSymbolReader (ModuleDefinition module, string fileName)
		{
			...
			var pdb_file_name = Root.Code.Libs.Mono.Cecil.Mixin.GetPdbFileName (fileName);

			if (File.Exists (pdb_file_name)) {
				if (Root.Code.Libs.Mono.Cecil.Mixin.IsPortablePdb (Root.Code.Libs.Mono.Cecil.Mixin.GetPdbFileName (fileName)))
			...
			var mdb_file_name = Root.Code.Libs.Mono.Cecil.Mixin.GetMdbFileName (fileName);
