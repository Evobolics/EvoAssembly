...
namespace Root.Code.Libs.Mono.Cecil.Cil {
	...
	public sealed class PortablePdbReaderProvider : ISymbolReaderProvider {
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckModule (module);
			Root.Code.Libs.Mono.Cecil.Mixin.CheckFileName (fileName);

			var file = File.OpenRead (Root.Code.Libs.Mono.Cecil.Mixin.GetPdbFileName (fileName));
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckModule (module);
			Root.Code.Libs.Mono.Cecil.Mixin.CheckStream (symbolStream);
	...
	public sealed class PortablePdbWriterProvider : ISymbolWriterProvider
	{
		public ISymbolWriter GetSymbolWriter (ModuleDefinition module, string fileName)
		{
			...
			var file = File.OpenWrite (Root.Code.Libs.Mono.Cecil.Mixin.GetPdbFileName (fileName));
