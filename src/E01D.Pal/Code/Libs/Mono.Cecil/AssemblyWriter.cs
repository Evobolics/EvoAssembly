...
using Root.Code.Libs.Mono.Security.Cryptography;
...
namespace Root.Code.Libs.Mono.Cecil {
	...
	sealed class TypeDefTable : MetadataTable<Row<TypeAttributes, uint, uint, uint, uint, uint>> {
	...
	sealed class FileTable : MetadataTable<Row<FileAttributes, uint, uint>> {
