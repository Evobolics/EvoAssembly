...
namespace Root.Code.Libs.Mono.Cecil
{
	...
	public class MethodReference : MemberReference, IMethodSignature, IGenericParameterProvider, IGenericContext {
		...
		public MethodReference (string name, TypeReference returnType)
			: base (name)
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckType (returnType, Root.Code.Libs.Mono.Cecil.Mixin.Argument.returnType);
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckType (declaringType, Root.Code.Libs.Mono.Cecil.Mixin.Argument.declaringType);
