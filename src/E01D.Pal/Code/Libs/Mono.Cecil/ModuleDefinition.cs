...
using ICustomAttributeProvider = Root.Code.Libs.Mono.Cecil.ICustomAttributeProvider;
using SR = System.Reflection;
using TypeAttributes = Root.Code.Libs.Mono.Cecil.TypeAttributes;
...
namespace Root.Code.Libs.Mono.Cecil {
	...
	public sealed class ModuleDefinition : ModuleReference, ICustomAttributeProvider, ICustomDebugInformationProvider, IDisposable {
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckFullName (fullName);
		...
		static AssemblyNameDefinition CreateAssemblyName (string name)
		{
			...
			return new AssemblyNameDefinition (name, Root.Code.Libs.Mono.Cecil.Mixin.ZeroVersion);
		}
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckFileName (fileName);
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckStream (stream);
			Root.Code.Libs.Mono.Cecil.Mixin.CheckReadSeek (stream);
		...
		{
			Root.Code.Libs.Mono.Cecil.Mixin.CheckStream (stream);
			Root.Code.Libs.Mono.Cecil.Mixin.CheckWriteSeek (stream);
			Root.Code.Libs.Mono.Cecil.Mixin.CheckParameters (parameters);
