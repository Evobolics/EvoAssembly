...
namespace Root.Code.Libs.Mono.Cecil.Metadata {
	...
	sealed class TableHeapBuffer : HeapBuffer {
		...
		readonly internal TableInformation [] table_infos = new TableInformation [Root.Code.Libs.Mono.Cecil.Mixin.TableCount];
		readonly internal MetadataTable [] tables = new MetadataTable [Root.Code.Libs.Mono.Cecil.Mixin.TableCount];

		bool large_string;
		bool large_blob;
		bool large_guid;

		readonly int [] coded_index_sizes = new int [Root.Code.Libs.Mono.Cecil.Mixin.CodedIndexCount];
