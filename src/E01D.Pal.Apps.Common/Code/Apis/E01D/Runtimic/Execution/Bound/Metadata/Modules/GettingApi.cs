...
namespace Root.Code.Apis.E01D.Runtimic.Execution.Bound.Metadata.Modules
{
    ...
    {
	    public SemanticModuleMask_I Get(InfrastructureRuntimicModelMask_I model, System.Type type) // BELONGS HERE Because it takes in a TYPE
	    {
	    ...
	    public SemanticModuleMask_I Get(InfrastructureRuntimicModelMask_I model, TypeReference typeReference) // BELONGS HERE Because it takes in a TYPE
	    {
		...
		public SemanticModuleMask_I Get(InfrastructureRuntimicModelMask_I semanticModel, BoundAssemblyMask_I boundAssembly, TypeReference typeReference)
        {
