...
namespace Root.Code.Apis.E01D.Runtimic.Execution.Bound.Metadata.Members.Constructors
{
    public interface ConstructorApiMask_I
    {
		...
		ConstructorInfo FindConstructorBySignature(InfrastructureRuntimicModelMask_I conversionModel, BoundTypeDefinitionMask_I declaringType, MethodReference methodReference);
    }
}
