using Root.Code.Apis.E01D.Runtimic.Execution.Bound.Metadata.Members.Types.Building;
...
{
	public class TypeApi<TContainer> : BoundApiNode<TContainer>, TypeApi_I<TContainer>
