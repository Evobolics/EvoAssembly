...
namespace Root.Code.Apis.E01D.Runtimic.Infrastructure.Structural.Cecil.Metadata.Members.Constructors.Getting.FromConstructorInfo
{
	public interface DefinitionApiMask_I
	{
		...
		/// type reference.
		/// </summary>
		MethodDefinition GetMethodDefinition(InfrastructureRuntimicModelMask_I model, TypeReference typeReference, ConstructorInfo method);
		...
		/// <returns></returns>
		MethodDefinition GetMethodDefinition(InfrastructureRuntimicModelMask_I model, TypeDefinition typeDefinition, ConstructorInfo method);
	}
}
