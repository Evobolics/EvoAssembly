...
namespace Root.Code.Apis.E01D.Runtimic.Infrastructure.Structural.Cecil.Metadata.Members.Constructors.Getting.FromConstructorInfo
{
	public interface DefinitionApiMask_I
	{
		...
		/// type reference.
		/// </summary>
		MethodDefinition GetMethodDefinition(InfrastructureModelMask_I model, TypeReference typeReference, ConstructorInfo method);
		...
		/// <returns></returns>
		MethodDefinition GetMethodDefinition(InfrastructureModelMask_I model, TypeDefinition typeDefinition, ConstructorInfo method);
	}
}
