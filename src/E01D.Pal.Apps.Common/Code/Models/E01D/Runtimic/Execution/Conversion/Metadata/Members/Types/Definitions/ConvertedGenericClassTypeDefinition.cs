...
{
    public class ConvertedGenericClassTypeDefinition: ConvertedClassTypeDefinition, ConvertedGenericTypeDefinition_I
    {
        public ConvertedGenericClassTypeDefinition()
        {
        ...
        /// </summary>
        public List<SemanticGenericTypeDefinitionMask_I> Instances { get; set; } =new List<SemanticGenericTypeDefinitionMask_I>();
