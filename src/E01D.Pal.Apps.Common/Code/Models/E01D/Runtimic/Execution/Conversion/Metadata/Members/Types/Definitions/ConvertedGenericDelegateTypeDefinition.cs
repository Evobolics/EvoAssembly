...
{
    public class ConvertedGenericDelegateTypeDefinition: ConvertedDelegateTypeDefinition, ConvertedGenericTypeDefinition_I
    {

        public ConvertedGenericDelegateTypeDefinition()
        {
